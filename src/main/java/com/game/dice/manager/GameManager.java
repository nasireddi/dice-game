package com.game.dice.manager;

import com.game.dice.utils.SortByPoints;
import com.game.dice.utils.SortByWonPositions;
...
public class GameManager {
    ...
    public static void playGame(ArrayList<ArrayList<Integer>> list) {
